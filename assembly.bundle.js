...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Kt,depthTest:!1,depthWrite:!1})}function ll(){return new ht({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Va(),fragmentShader:`
		...
		`,blending:Kt,depthTest:!1,depthWrite:!1})}function cl(){return new ht({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Va(),fragmentShader:`
	...
	`}function Bf(i){let e=new WeakMap,t=null;function n(a){if(a&&a.isTexture){let l=a.mapping,c=l===Kr||l===Qr,h=l===mi||l===gi;if(c||h)if(a.isRenderTargetTexture&&a.needsPMREMUpdate===!0){a.needsPMREMUpdate=!1;let d=e.get(a);return t===null&&(t=new Hs(i)),d=c?t.fromEquirectangular(a,d):t.fromCubemap(a,d),e.set(a,d),d.texture}else{if(e.has(a))return e.get(a).texture;{let d=a.image;if(c&&d&&d.height>0||h&&d&&s(d)){t===null&&(t=new Hs(i));let f=c?t.fromEquirectangular(a):t.fromCubemap(a);return e.set(a,f),a.addEventListener("dispose",r),f.texture}else return null}}}return a}function s(a){let l=0,c=6;for(let h=0;h<c;h++)a[h]!==void 0&&l++;return l===c}function r(a){let l=a.target;l.removeEventListener("dispose",r);let c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:o}}function zf(i){let e={};function t(n){if(e[n]!==void 0)return e[n];let s;switch(n){case"WEBGL_depth_texture":s=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":s=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":s=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":s=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:s=i.getExtension(n)}return e[n]=s,s}return{has:function(n){return t(n)!==null},init:function(n){n.isWebGL2?(t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance")):(t("WEBGL_depth_texture"),t("OES_texture_float"),t("OES_texture_half_float"),t("OES_texture_half_float_linear"),t("OES_standard_derivatives"),t("OES_element_index_uint"),t("OES_vertex_array_object"),t("ANGLE_instanced_arrays")),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture")},get:function(n){let s=t(n);return s===null&&console.warn("THREE.WebGLRenderer: "+n+" extension not supported."),s}}}function Vf(i,e,t,n){let s={},r=new WeakMap;function o(d){let f=d.target;f.index!==null&&e.remove(f.index);for(let g in f.attributes)e.remove(f.attributes[g]);for(let g in f.morphAttributes){let _=f.morphAttributes[g];for(let p=0,u=_.length;p<u;p++)e.remove(_[p])}f.removeEventListener("dispose",o),delete s[f.id];let m=r.get(f);m&&(e.remove(m),r.delete(f)),n.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,t.memory.geometries--}function a(d,f){return s[f.id]===!0||(f.addEventListener("dispose",o),s[f.id]=!0,t.memory.geometries++),f}function l(d){let f=d.attributes;for(let g in f)e.update(f[g],i.ARRAY_BUFFER);let m=d.morphAttributes;for(let g in m){let _=m[g];for(let p=0,u=_.length;p<u;p++)e.update(_[p],i.ARRAY_BUFFER)}}function c(d){let f=[],m=d.index,g=d.attributes.position,_=0;if(m!==null){let E=m.array;_=m.version;for(let v=0,A=E.length;v<A;v+=3){let I=E[v+0],C=E[v+1],w=E[v+2];f.push(I,C,C,w,w,I)}}else if(g!==void 0){let E=g.array;_=g.version;for(let v=0,A=E.length/3-1;v<A;v+=3){let I=v+0,C=v+1,w=v+2;f.push(I,C,C,w,w,I)}}else return;let p=new(ql(f)?Bs:Fs)(f,1);p.version=_;let u=r.get(d);u&&e.remove(u),r.set(d,p)}function h(d){let f=r.get(d);if(f){let m=d.index;m!==null&&f.version<m.version&&c(d)}else c(d);return r.get(d)}return{get:a,update:l,getWireframeAttribute:h}}function kf(i,e,t,n){let s=n.isWebGL2,r;function o(m){r=m}let a,l;function c(m){a=m.type,l=m.bytesPerElement}function h(m,g){i.drawElements(r,g,a,m*l),t.update(g,r,1)}function d(m,g,_){if(_===0)return;let p,u;if(s)p=i,u="drawElementsInstanced";else if(p=e.get("ANGLE_instanced_arrays"),u="drawElementsInstancedANGLE",p===null){console.error("THREE.WebGLIndexedBufferRenderer: using THREE.InstancedBufferGeometry but hardware does not support extension ANGLE_instanced_arrays.");return}p[u](r,g,a,m*l,_),t.update(g,r,_)}function f(m,g,_){if(_===0)return;let p=e.get("WEBGL_multi_draw");if(p===null)for(let u=0;u<_;u++)this.render(m[u]/l,g[u]);else{p.multiDrawElementsWEBGL(r,g,0,a,m,0,_);let u=0;for(let E=0;E<_;E++)u+=g[E];t.update(u,r,1)}}this.setMode=o,this.setIndex=c,this.render=h,this.renderInstances=d,this.renderMultiDraw=f}function Hf(i){let e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,o,a){switch(t.calls++,o){case i.TRIANGLES:t.triangles+=a*(r/3);break;case i.LINES:t.lines+=a*(r/2);break;case i.LINE_STRIP:t.lines+=a*(r-1);break;case i.LINE_LOOP:t.lines+=a*r;break;case i.POINTS:t.points+=a*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:n}}function Gf(i,e){return i[0]-e[0]}function Wf(i,e){return Math.abs(e[1])-Math.abs(i[1])}function Xf(i,e,t){let n={},s=new Float32Array(8),r=new WeakMap,o=new dt,a=[];for(let c=0;c<8;c++)a[c]=[c,0];function l(c,h,d){let f=c.morphTargetInfluences;if(e.isWebGL2===!0){let m=h.morphAttributes.position||h.morphAttributes.normal||h.morphAttributes.color,g=m!==void 0?m.length:0,_=r.get(h);if(_===void 0||_.count!==g){let P=function(){J.dispose(),r.delete(h),h.removeEventListener("dispose",P)};_!==void 0&&_.texture.dispose();let E=h.morphAttributes.position!==void 0,v=h.morphAttributes.normal!==void 0,A=h.morphAttributes.color!==void 0,I=h.morphAttributes.position||[],C=h.morphAttributes.normal||[],w=h.morphAttributes.color||[],X=0;E===!0&&(X=1),v===!0&&(X=2),A===!0&&(X=3);let M=h.attributes.position.count*X,b=1;M>e.maxTextureSize&&(b=Math.ceil(M/e.maxTextureSize),M=e.maxTextureSize);let V=new Float32Array(M*b*4*g),J=new Ns(V,M,b,g);J.type=xn,J.needsUpdate=!0;let ie=X*4;for(let B=0;B<g;B++){let H=I[B],q=C[B],W=w[B],G=M*b*4*B;for(let K=0;K<H.count;K++){let ee=K*ie;E===!0&&(o.fromBufferAttribute(H,K),V[G+ee+0]=o.x,V[G+ee+1]=o.y,V[G+ee+2]=o.z,V[G+ee+3]=0),v===!0&&(o.fromBufferAttribute(q,K),V[G+ee+4]=o.x,V[G+ee+5]=o.y,V[G+ee+6]=o.z,V[G+ee+7]=0),A===!0&&(o.fromBufferAttribute(W,K),V[G+ee+8]=o.x,V[G+ee+9]=o.y,V[G+ee+10]=o.z,V[G+ee+11]=W.itemSize===4?o.w:1)}}_={count:g,texture:J,size:new Te(M,b)},r.set(h,_),h.addEventListener("dispose",P)}let p=0;for(let E=0;E<f.length;E++)p+=f[E];let u=h.morphTargetsRelative?1:1-p;d.getUniforms().setValue(i,"morphTargetBaseInfluence",u),d.getUniforms().setValue(i,"morphTargetInfluences",f),d.getUniforms().setValue(i,"morphTargetsTexture",_.texture,t),d.getUniforms().setValue(i,"morphTargetsTextureSize",_.size)}else{let m=f===void 0?0:f.length,g=n[h.id];if(g===void 0||g.length!==m){g=[];for(let v=0;v<m;v++)g[v]=[v,0];n[h.id]=g}for(let v=0;v<m;v++){let A=g[v];A[0]=v,A[1]=f[v]}g.sort(Wf);for(let v=0;v<8;v++)v<m&&g[v][1]?(a[v][0]=g[v][0],a[v][1]=g[v][1]):(a[v][0]=Number.MAX_SAFE_INTEGER,a[v][1]=0);a.sort(Gf);let _=h.morphAttributes.position,p=h.morphAttributes.normal,u=0;for(let v=0;v<8;v++){let A=a[v],I=A[0],C=A[1];I!==Number.MAX_SAFE_INTEGER&&C?(_&&h.getAttribute("morphTarget"+v)!==_[I]&&h.setAttribute("morphTarget"+v,_[I]),p&&h.getAttribute("morphNormal"+v)!==p[I]&&h.setAttribute("morphNormal"+v,p[I]),s[v]=C,u+=C):(_&&h.hasAttribute("morphTarget"+v)===!0&&h.deleteAttribute("morphTarget"+v),p&&h.hasAttribute("morphNormal"+v)===!0&&h.deleteAttribute("morphNormal"+v),s[v]=0)}let E=h.morphTargetsRelative?1:1-u;d.getUniforms().setValue(i,"morphTargetBaseInfluence",E),d.getUniforms().setValue(i,"morphTargetInfluences",s)}}return{update:l}}function qf(i,e,t,n){let s=new WeakMap;function r(l){let c=n.render.frame,h=l.geometry,d=e.get(l,h);if(s.get(d)!==c&&(e.update(d),s.set(d,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",a)===!1&&l.addEventListener("dispose",a),s.get(l)!==c&&(t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER),s.set(l,c))),l.isSkinnedMesh){let f=l.skeleton;s.get(f)!==c&&(f.update(),s.set(f,c))}return d}function o(){s=new WeakMap}function a(l){let c=l.target;c.removeEventListener("dispose",a),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:r,dispose:o}}var Gs=class extends Yt{constructor(e,t,n,s,r,o,a,l,c,h){if(h=h!==void 0?h:kn,h!==kn&&h!==_i)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&h===kn&&(n=_n),n===void 0&&h===_i&&(n=Vn),super(null,s,r,o,a,l,h,n,c),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=a!==void 0?a:yt,this.minFilter=l!==void 0?l:yt,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){let t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}},$l=new Yt,Kl=new Gs(1,1);Kl.compareFunction=Xl;var Ql=new Ns,jl=new ra,ec=new Vs,hl=[],ul=[],dl=new Float32Array(16),fl=new Float32Array(9),pl=new Float32Array(4);function Si(i,e,t){let n=i[0];if(n<=0||n>0)return i;let s=e*t,r=hl[s];if(r===void 0&&(r=new Float32Array(s),hl[s]=r),e!==0){n.toArray(r,0);for(let o=1,a=0;o!==e;++o)a+=t,i[o].toArray(r,a)}return r}function st(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function rt(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function js(i,e){let t=ul[e];t===void 0&&(t=new Int32Array(e),ul[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function Yf(i,e){let t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function Zf(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(st(t,e))return;i.uniform2fv(this.addr,e),rt(t,e)}}function Jf(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(st(t,e))return;i.uniform3fv(this.addr,e),rt(t,e)}}function $f(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(st(t,e))return;i.uniform4fv(this.addr,e),rt(t,e)}}function Kf(i,e){let t=this.cache,n=e.elements;if(n===void 0){if(st(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),rt(t,e)}else{if(st(t,n))return;pl.set(n),i.uniformMatrix2fv(this.addr,!1,pl),rt(t,n)}}function Qf(i,e){let t=this.cache,n=e.elements;if(n===void 0){if(st(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),rt(t,e)}else{if(st(t,n))return;fl.set(n),i.uniformMatrix3fv(this.addr,!1,fl),rt(t,n)}}function jf(i,e){let t=this.cache,n=e.elements;if(n===void 0){if(st(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),rt(t,e)}else{if(st(t,n))return;dl.set(n),i.uniformMatrix4fv(this.addr,!1,dl),rt(t,n)}}function ep(i,e){let t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function tp(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(st(t,e))return;i.uniform2iv(this.addr,e),rt(t,e)}}function np(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(st(t,e))return;i.uniform3iv(this.addr,e),rt(t,e)}}function ip(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(st(t,e))return;i.uniform4iv(this.addr,e),rt(t,e)}}function sp(i,e){let t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function rp(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(st(t,e))return;i.uniform2uiv(this.addr,e),rt(t,e)}}function ap(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(st(t,e))return;i.uniform3uiv(this.addr,e),rt(t,e)}}function op(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(st(t,e))return;i.uniform4uiv(this.addr,e),rt(t,e)}}function lp(i,e,t){let n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r=this.type===i.SAMPLER_2D_SHADOW?Kl:$l;t.setTexture2D(e||r,s)}function cp(i,e,t){let n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture3D(e||jl,s)}function hp(i,e,t){let n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTextureCube(e||ec,s)}function up(i,e,t){let n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture2DArray(e||Ql,s)}function dp(i){switch(i){case 5126:return Yf;case 35664:return Zf;case 35665:return Jf;case 35666:return $f;case 35674:return Kf;case 35675:return Qf;case 35676:return jf;case 5124:case 35670:return ep;case 35667:case 35671:return tp;case 35668:case 35672:return np;case 35669:case 35673:return ip;case 5125:return sp;case 36294:return rp;case 36295:return ap;case 36296:return op;case 35678:case 36198:case 36298:case 36306:case 35682:return lp;case 35679:case 36299:case 36307:return cp;case 35680:case 36300:case 36308:case 36293:return hp;case 36289:case 36303:case 36311:case 36292:return up}}function fp(i,e){i.uniform1fv(this.addr,e)}function pp(i,e){let t=Si(e,this.size,2);i.uniform2fv(this.addr,t)}function mp(i,e){let t=Si(e,this.size,3);i.uniform3fv(this.addr,t)}function gp(i,e){let t=Si(e,this.size,4);i.uniform4fv(this.addr,t)}function _p(i,e){let t=Si(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function xp(i,e){let t=Si(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function vp(i,e){let t=Si(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function yp(i,e){i.uniform1iv(this.addr,e)}function Mp(i,e){i.uniform2iv(this.addr,e)}function Sp(i,e){i.uniform3iv(this.addr,e)}function bp(i,e){i.uniform4iv(this.addr,e)}function Ep(i,e){i.uniform1uiv(this.addr,e)}function Tp(i,e){i.uniform2uiv(this.addr,e)}function wp(i,e){i.uniform3uiv(this.addr,e)}function Ap(i,e){i.uniform4uiv(this.addr,e)}function Cp(i,e,t){let n=this.cache,s=e.length,r=js(t,s);st(n,r)||(i.uniform1iv(this.addr,r),rt(n,r));for(let o=0;o!==s;++o)t.setTexture2D(e[o]||$l,r[o])}function Rp(i,e,t){let n=this.cache,s=e.length,r=js(t,s);st(n,r)||(i.uniform1iv(this.addr,r),rt(n,r));for(let o=0;o!==s;++o)t.setTexture3D(e[o]||jl,r[o])}function Pp(i,e,t){let n=this.cache,s=e.length,r=js(t,s);st(n,r)||(i.uniform1iv(this.addr,r),rt(n,r));for(let o=0;o!==s;++o)t.setTextureCube(e[o]||ec,r[o])}function Lp(i,e,t){let n=this.cache,s=e.length,r=js(t,s);st(n,r)||(i.uniform1iv(this.addr,r),rt(n,r));for(let o=0;o!==s;++o)t.setTexture2DArray(e[o]||Ql,r[o])}function Ip(i){switch(i){case 5126:return fp;case 35664:return pp;case 35665:return mp;case 35666:return gp;case 35674:return _p;case 35675:return xp;case 35676:return vp;case 5124:case 35670:return yp;case 35667:case 35671:return Mp;case 35668:case 35672:return Sp;case 35669:case 35673:return bp;case 5125:return Ep;case 36294:return Tp;case 36295:return wp;case 36296:return Ap;case 35678:case 36198:case 36298:case 36306:case 35682:return Cp;case 35679:case 36299:case 36307:return Rp;case 35680:case 36300:case 36308:case 36293:return Pp;case 36289:case 36303:case 36311:case 36292:return Lp}}var ca=class{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=dp(t.type)}},ha=class{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Ip(t.type)}},ua=class{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){let s=this.seq;for(let r=0,o=s.length;r!==o;++r){let a=s[r];a.setValue(e,t[a.id],n)}}},qr=/(\w+)(\])?(\[|\.)?/g;function ml(i,e){i.seq.push(e),i.map[e.id]=e}function Up(i,e,t){let n=i.name,s=n.length;for(qr.lastIndex=0;;){let r=qr.exec(n),o=qr.lastIndex,a=r[1],l=r[2]==="]",c=r[3];if(l&&(a=a|0),c===void 0||c==="["&&o+2===s){ml(t,c===void 0?new ca(a,i,e):new ha(a,i,e));break}else{let d=t.map[a];d===void 0&&(d=new ua(a),ml(t,d)),t=d}}}var pi=class{constructor(e,t){this.seq=[],this.map={};let n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let s=0;s<n;++s){let r=e.getActiveUniform(t,s),o=e.getUniformLocation(t,r.name);Up(r,o,this)}}setValue(e,t,n,s){let r=this.map[t];r!==void 0&&r.setValue(e,n,s)}setOptional(e,t,n){let s=t[n];s!==void 0&&this.setValue(e,n,s)}static upload(e,t,n,s){for(let r=0,o=t.length;r!==o;++r){let a=t[r],l=n[a.id];l.needsUpdate!==!1&&a.setValue(e,l.value,s)}}static seqWithValue(e,t){let n=[];for(let s=0,r=e.length;s!==r;++s){let o=e[s];o.id in t&&n.push(o)}return n}};function gl(i,e,t){let n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}var Dp=37297,Np=0;function Op(i,e){let t=i.split(`
`),n=[],s=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let o=s;o<r;o++){let a=o+1;n.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return n.join(`
`)}function Fp(i){let e=Ge.getPrimaries(Ge.workingColorSpace),t=Ge.getPrimaries(i),n;switch(e===t?n="":e===Ps&&t===Rs?n="LinearDisplayP3ToLinearSRGB":e===Rs&&t===Ps&&(n="LinearSRGBToLinearDisplayP3"),i){case hn:case Qs:return[n,"LinearTransferOETF"];case ut:case za:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",i),[n,"LinearTransferOETF"]}}function _l(i,e,t){let n=i.getShaderParameter(e,i.COMPILE_STATUS),s=i.getShaderInfoLog(e).trim();if(n&&s==="")return"";let r=/ERROR: 0:(\d+)/.exec(s);if(r){let o=parseInt(r[1]);return t.toUpperCase()+`

`+s+`

`+Op(i.getShaderSource(e),o)}else return s}function Bp(i,e){let t=Fp(e);return`vec4 ${i}( vec4 value ) { return ${t[0]}( ${t[1]}( value ) ); }`}function zp(i,e){let t;switch(e){case Ua:t="Linear";break;case Da:t="Reinhard";break;case Na:t="OptimizedCineon";break;case Oa:t="ACESFilmic";break;case Fa:t="AgX";break;case oh:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}function Vp(i){return[i.extensionDerivatives||i.envMapCubeUVHeight||i.bumpMap||i.normalMapTangentSpace||i.clearcoatNormalMap||i.flatShading||i.shaderID==="physical"?"#extension GL_OES_standard_derivatives : enable":"",(i.extensionFragDepth||i.logarithmicDepthBuffer)&&i.rendererExtensionFragDepth?"#extension GL_EXT_frag_depth : enable":"",i.extensionDrawBuffers&&i.rendererExtensionDrawBuffers?"#extension GL_EXT_draw_buffers : require":"",(i.extensionShaderTextureLOD||i.envMap||i.transmission)&&i.rendererExtensionShaderTextureLod?"#extension GL_EXT_shader_texture_lod : enable":""].filter(ui).join(`
...
`)}function Gp(i,e){let t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){let r=i.getActiveAttrib(e,s),o=r.name,a=1;r.type===i.FLOAT_MAT2&&(a=2),r.type===i.FLOAT_MAT3&&(a=3),r.type===i.FLOAT_MAT4&&(a=4),t[o]={type:r.type,location:i.getAttribLocation(e,o),locationSize:a}}return t}function ui(i){return i!==""}function xl(i,e){let t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function vl(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}var Wp=/^[ \t]*#include +<([\w\d./]+)>/gm;function da(i){return i.replace(Wp,qp)}var Xp=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function qp(i,e){let t=De[e];if(t===void 0){let n=Xp.get(e);if(n!==void 0)t=De[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return da(t)}var Yp=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function yl(i){return i.replace(Yp,Zp)}function Zp(i,e,t,n){let s="";for(let r=parseInt(e);r<parseInt(t);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function Ml(i){let e="precision "+i.precision+` float;
precision `+i.precision+" int;";return i.precision==="highp"?e+=`
#define HIGH_PRECISION`:i.precision==="mediump"?e+=`
#define MEDIUM_PRECISION`:i.precision==="lowp"&&(e+=`
#define LOW_PRECISION`),e}function Jp(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Dl?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===Nc?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===on&&(e="SHADOWMAP_TYPE_VSM"),e}function $p(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case mi:case gi:e="ENVMAP_TYPE_CUBE";break;case Ks:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Kp(i){let e="ENVMAP_MODE_REFLECTION";return i.envMap&&i.envMapMode===gi&&(e="ENVMAP_MODE_REFRACTION"),e}function Qp(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Nl:e="ENVMAP_BLENDING_MULTIPLY";break;case rh:e="ENVMAP_BLENDING_MIX";break;case ah:e="ENVMAP_BLENDING_ADD";break}return e}function jp(i){let e=i.envMapCubeUVHeight;if(e===null)return null;let t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function em(i,e,t,n){let s=i.getContext(),r=t.defines,o=t.vertexShader,a=t.fragmentShader,l=Jp(t),c=$p(t),h=Kp(t),d=Qp(t),f=jp(t),m=t.isWebGL2?"":Vp(t),g=kp(t),_=Hp(r),p=s.createProgram(),u,E,v=t.glslVersion?"#version "+t.glslVersion+`
	...
	gl_FragColor = pack2HalfToRGBA( vec2( mean, std_dev ) );
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};bi.BlurDirectionX=new Te(1,0);bi.BlurDirectionY=new Te(0,1);var nc={name:"OutputShader",uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		...
		}`};var rr=class extends Dt{constructor(){super();let e=nc;this.uniforms=An.clone(e.uniforms),this.material=new Js({name:e.name,uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader}),this.fsQuad=new Cn(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},Ge.getTransfer(this._outputColorSpace)===qe&&(this.material.defines.SRGB_TRANSFER=""),this._toneMapping===Ua?this.material.defines.LINEAR_TONE_MAPPING="":this._toneMapping===Da?this.material.defines.REINHARD_TONE_MAPPING="":this._toneMapping===Na?this.material.defines.CINEON_TONE_MAPPING="":this._toneMapping===Oa?this.material.defines.ACES_FILMIC_TONE_MAPPING="":this._toneMapping===Fa&&(this.material.defines.AGX_TONE_MAPPING=""),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this.fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this.fsQuad.render(e))}dispose(){this.material.dispose(),this.fsQuad.dispose()}};var Ei=new Xs;Ei.background=new ye(67600);Ei.fog=new Ws(67600,18,75);var it=new Mt(55,16/7,.1,300);it.position.set(0,0,35);var Xa=new Vi({canvas:document.getElementById("assembly-canvas"),antialias:!0,alpha:!0,powerPreference:"high-performance"});Xa.setPixelRatio(Math.min(window.devicePixelRatio,2));var Wa=document.getElementById("assembly-component"),Ti=new ir(Xa);Ti.addPass(new sr(Ei,it));var Um=new bi(new Te(Wa.clientWidth,Wa.clientHeight),.18,.4,.25);Ti.addPass(Um);Ti.addPass(new rr);function ic(){let i=Wa.getBoundingClientRect();Xa.setSize(i.width,i.height,!1),Ti.setSize(i.width,i.height),it.aspect=i.width/i.height,it.updateProjectionMatrix()}ic();window.addEventListener("resize",ic);var Rn=11,qa=3.2,Ya=1.4,sc=document.getElementById("config-count");sc&&(sc.textContent=(Rn*Rn*Rn).toLocaleString());var un=new vn;Ei.add(un);var rc=new Xn(Ya,Ya,Ya),Dm=new Zs(rc);function Nm(i,e,t){let n=(i+Rn)/(Rn*2),s=(t+Rn)/(Rn*2),r=new ye(9211122),o=new ye(29670),a=new ye(2282478),l=new ye;return l.copy(r).lerp(o,n),l.lerp(a,s*.4),l}function Om(i){return new ki({color:i,transparent:!0,opacity:.85,blending:bn,depthWrite:!1})}function Fm(i){return new wn({color:i,transparent:!0,opacity:.04,blending:bn,depthWrite:!1,side:Gt})}var or=[],wi=Math.floor(Rn/2);for(let i=-wi;i<=wi;i++)for(let e=-wi;e<=wi;e++)for(let t=-wi;t<=wi;t++){let n=Nm(i,e,t),s=new qs(Dm,Om(n)),r=new At(rc,Fm(n)),o=i*qa,a=e*qa,l=t*qa;s.position.set(o,a,l),r.position.set(o,a,l),r.userData={x:i,y:e,z:t,isCube:!0,edgesRef:s,baseColor:n.clone()},un.add(r),un.add(s),or.push({face:r,edges:s,x:i,y:e,z:t,baseColor:n.clone()})}var Za=new Rt,Ja=400,ar=new Float32Array(Ja*3),Qt=new Float32Array(Ja*3);for(let i=0;i<Ja;i++){ar[i*3]=(Math.random()-.5)*80,ar[i*3+1]=(Math.random()-.5)*60,ar[i*3+2]=(Math.random()-.5)*80;let e=Math.random();e<.4?(Qt[i*3]=0,Qt[i*3+1]=.63,Qt[i*3+2]=1):e<.8?(Qt[i*3]=.13,Qt[i*3+1]=.83,Qt[i*3+2]=.93):(Qt[i*3]=.55,Qt[i*3+1]=.55,Qt[i*3+2]=.95)}Za.setAttribute("position",new St(ar,3));Za.setAttribute("color",new St(Qt,3));var Bm=new Hi({size:.08,vertexColors:!0,transparent:!0,opacity:.7,blending:bn,depthWrite:!1}),lr=new Ys(Za,Bm);Ei.add(lr);var ac=["Claude Opus 4.7","Claude Sonnet 4.6","Claude Haiku 4.5","Claude Opus 4.6","GPT-5","GPT-5 Turbo","GPT-4o","o3-mini","o4-pro","Gemini 2.5 Pro","Gemini 2.5 Flash","Gemini Ultra 2","Grok-4","Grok-3 Beta","Llama 4 405B","Llama 4 70B","Llama 3.3 Instruct","Mistral Large 3","DeepSeek-V3","Qwen-3 Max"],oc=["PRM-base-v2.1","PRM-cot-v3.0","PRM-react-v1.8","PRM-tot-v2.4","PRM-direct-v1.2","PRM-stepwise-v3.1","PRM-socratic-v2.0","PRM-rag-v4.2"],lc=["tool-search@6.325","tool-search@6.412","tool-search@7.001","tool-rag@2.18.0","tool-rag@2.19.3","tool-sql@4.7.2","tool-bash@1.12.0","tool-fetch@3.8.1","tool-code@9.4.0"],cc=["gr-strict-v1.4","gr-balanced-v2.1","gr-creative-v1.0","gr-pii-shield-v3.2","gr-toxicity-v2.5","gr-jailbreak-v4.1","gr-redteam-v1.9","gr-compliance-v3.0"],hc=["POL-101","POL-104","POL-118","POL-122","POL-130","POL-147","POL-203","POL-211","POL-224","POL-238","POL-302","POL-317","POL-405","POL-412","POL-507"],uc=["golden-set-v1.4","golden-set-v2.0","eval-corpus-q4","prod-traffic-30d","redteam-suite-v3","adversarial-v1.2","synthetic-edge-v2","longtail-v4.1"];function zm(i){return function(){i|=0,i=i+1831565813|0;let e=Math.imul(i^i>>>15,1|i);return e=e+Math.imul(e^e>>>7,61|e)^e,((e^e>>>14)>>>0)/4294967296}}function Vm(i,e,t){return(i*73856093^e*19349663^t*83492791)>>>0}function Ai(i,e){return i[Math.floor(e()*i.length)]}function dc(i,e,t){let n=Vm(i+1e3,e+1e3,t+1e3),s=zm(n),r=Math.abs(i)%9+1,o=Math.abs(e)%12,a=Math.abs(t)%99;return{id:`CFG-${(n%65536).toString(16).toUpperCase().padStart(4,"0")}`,version:`v${r}.${o}.${a}`,model:Ai(ac,s),prompt:Ai(oc,s),tools:Ai(lc,s),guardrails:Ai(cc,s),policy:Ai(hc,s),data:Ai(uc,s),score:(.72+s()*.27).toFixed(4),hash:`0x${(n%65535).toString(16).toUpperCase().padStart(4,"0")}`,coord:`[${i},${e},${t}]`}}var R={panOffsetX:0,panOffsetY:0,panOffsetZ:0,panTargetX:0,panTargetY:0,panTargetZ:0,panVelX:0,panVelY:0,panVelZ:0,zoom:35,zoomTarget:35,isDragging:!1,dragMoved:0,lastPointerTime:0,isIdle:!0,idleTime:0,idleAngle:0,wakeTransitionTime:1,wakeStartQuat:null,wakeStartPos:null,selectedCube:null,selectedEdges:null,exploredCount:0,explored:new Set,isPinned:!1,inspectorHideTimer:null,inspectorShowTimer:null,elapsed:0,cameraYaw:0,cameraPitch:0,cameraYawVel:0,cameraPitchVel:0,keys:{w:!1,a:!1,s:!1,d:!1}};var fc=5e3,km=400,Hm=document.getElementById("assembly-component"),cr=document.getElementById("inspector"),$a=document.getElementById("insp-pin");$a&&$a.addEventListener("click",i=>{i.stopPropagation(),R.isPinned=!R.isPinned,$a.classList.toggle("pinned",R.isPinned),R.isPinned?R.inspectorHideTimer&&(clearTimeout(R.inspectorHideTimer),R.inspectorHideTimer=null):cr.classList.contains("visible")&&(R.inspectorHideTimer=setTimeout(()=>hr(),fc))});function pc(i,e){if(R.selectedCube&&R.selectedCube!==i){let n=R.selectedCube.userData.baseColor;R.selectedEdges.material.color.copy(n),R.selectedEdges.material.opacity=.85,R.selectedCube.material.color.copy(n),R.selectedCube.material.opacity=.04,R.selectedCube.scale.set(1,1,1),R.selectedEdges.scale.set(1,1,1)}R.selectedCube=i,R.selectedEdges=e;let t=new ye(41471);e.material.color.copy(t),e.material.opacity=1,i.material.color.copy(t),i.material.opacity=.35,i.scale.set(1.15,1.15,1.15),e.scale.set(1.15,1.15,1.15)}function hr(){if(!R.isPinned&&(R.inspectorShowTimer&&(clearTimeout(R.inspectorShowTimer),R.inspectorShowTimer=null),cr.classList.remove("visible"),R.selectedCube)){let i=R.selectedCube.userData.baseColor;R.selectedEdges.material.color.copy(i),R.selectedEdges.material.opacity=.85,R.selectedCube.material.color.copy(i),R.selectedCube.material.opacity=.04,R.selectedCube.scale.set(1,1,1),R.selectedEdges.scale.set(1,1,1),R.selectedCube=null,R.selectedEdges=null}}function mc(i){let{x:e,y:t,z:n}=i.userData,s=dc(e,t,n);document.getElementById("insp-id").textContent=s.id,document.getElementById("insp-version").textContent=s.version,document.getElementById("insp-model").textContent=s.model,document.getElementById("insp-prompt").textContent=s.prompt,document.getElementById("insp-tools").textContent=s.tools,document.getElementById("insp-guardrails").textContent=s.guardrails,document.getElementById("insp-policy").textContent=s.policy,document.getElementById("insp-data").textContent=s.data,document.getElementById("insp-score").textContent=s.score,document.getElementById("insp-coord").textContent=s.coord,document.getElementById("insp-hash").textContent=s.hash;let r=`${e},${t},${n}`;if(R.explored.has(r)||(R.explored.add(r),R.exploredCount++,document.getElementById("explored-count").textContent=R.exploredCount),Hm.classList.remove("instructions-off"),R.inspectorHideTimer&&clearTimeout(R.inspectorHideTimer),R.inspectorShowTimer&&clearTimeout(R.inspectorShowTimer),R.isPinned){cr.classList.add("visible");return}R.inspectorShowTimer=setTimeout(()=>{cr.classList.add("visible"),R.inspectorHideTimer=setTimeout(()=>hr(),fc)},km)}var jt=document.getElementById("assembly-component");R.wakeStartQuat=new zt;R.wakeStartPos=new L;var gc=new $s,Gm=new Te,Ci=new Te,ur=new L,dr=new L,vc=0,yc=0,Wm="ontouchstart"in window||navigator.maxTouchPoints>0;Wm?document.getElementById("hud-hint").innerHTML='<div><span class="key">DRAG</span> pan space</div><div><span class="key">TAP</span> inspect</div><div><span class="key">PINCH</span> zoom</div>':document.getElementById("hud-hint").innerHTML='<div><span class="key">WASD</span> orbit \xB7 tilt</div><div><span class="key">DRAG</span> pan &nbsp; <span class="key">SCROLL</span> zoom</div><div><span class="key">CLICK</span> inspect</div>';function Mc(i){let e=jt.getBoundingClientRect();return i.touches&&i.touches.length>0?{x:i.touches[0].clientX-e.left,y:i.touches[0].clientY-e.top,nx:(i.touches[0].clientX-e.left)/e.width*2-1,ny:-((i.touches[0].clientY-e.top)/e.height)*2+1}:{x:i.clientX-e.left,y:i.clientY-e.top,nx:(i.clientX-e.left)/e.width*2-1,ny:-((i.clientY-e.top)/e.height)*2+1}}function Sc(i){if(i.touches&&i.touches.length>=2)return;let e=Mc(i);R.isDragging=!0,Gm.set(e.x,e.y),Ci.set(e.x,e.y),R.dragMoved=0,R.panVelX=0,R.panVelY=0,R.panVelZ=0,R.lastPointerTime=performance.now(),i.touches&&i.preventDefault()}function bc(i){if(!R.isDragging||i.touches&&i.touches.length>=2)return;let e=Mc(i),t=e.x-Ci.x,n=e.y-Ci.y;R.dragMoved+=Math.abs(t)+Math.abs(n),ur.setFromMatrixColumn(it.matrixWorld,0),dr.setFromMatrixColumn(it.matrixWorld,1);let s=.04,r=(-t*ur.x+n*dr.x)*s,o=(-t*ur.y+n*dr.y)*s,a=(-t*ur.z+n*dr.z)*s;R.panTargetX+=r,R.panTargetY+=o,R.panTargetZ+=a;let l=performance.now(),c=Math.max(1,l-R.lastPointerTime);R.panVelX=r/c*16,R.panVelY=o/c*16,R.panVelZ=a/c*16,R.lastPointerTime=l,Ci.set(e.x,e.y),i.touches&&i.preventDefault()}function Ec(i){if(!R.isDragging)return;if(R.isDragging=!1,R.dragMoved<8){let t,n;if(i.changedTouches&&i.changedTouches.length>0){let r=jt.getBoundingClientRect();t=(i.changedTouches[0].clientX-r.left)/r.width*2-1,n=-((i.changedTouches[0].clientY-r.top)/r.height)*2+1}else{let r=jt.getBoundingClientRect();t=Ci.x/r.width*2-1,n=-(Ci.y/r.height)*2+1}gc.setFromCamera(new Te(t,n),it);let s=gc.intersectObjects(or.map(r=>r.face),!1);if(s.length>0){let r=s[0].object,o=or.find(a=>a.face===r);o&&(pc(o.face,o.edges),mc(o.face))}else R.isPinned||hr()}}function Xm(i){if(i.touches.length===2){R.isDragging=!1;let e=i.touches[0].clientX-i.touches[1].clientX,t=i.touches[0].clientY-i.touches[1].clientY;vc=Math.hypot(e,t),yc=R.zoomTarget,i.preventDefault()}else Sc(i)}function qm(i){if(i.touches.length===2){let e=i.touches[0].clientX-i.touches[1].clientX,t=i.touches[0].clientY-i.touches[1].clientY,n=Math.hypot(e,t)/vc;R.zoomTarget=Math.max(8,Math.min(70,yc/n)),i.preventDefault()}else bc(i)}function _c(i){i.touches.length<2&&Ec(i)}function Ym(i){i.preventDefault(),!R.isDragging&&(R.zoomTarget=Math.max(8,Math.min(70,R.zoomTarget+i.deltaY*.04)))}function xc(){if(!R.isIdle)return;R.isIdle=!1,document.getElementById("assembly-component").classList.remove("idle");let i=it.position.length();R.zoom=i,R.zoomTarget=Math.max(20,Math.min(45,i)),R.cameraYaw=Math.atan2(it.position.x,it.position.z),R.cameraPitch=Math.asin(Math.max(-1,Math.min(1,it.position.y/i))),R.wakeTransitionTime=1}function Tc(){jt.addEventListener("mousedown",Sc),window.addEventListener("mousemove",bc),window.addEventListener("mouseup",Ec),jt.addEventListener("wheel",Ym,{passive:!1}),jt.addEventListener("touchstart",Xm,{passive:!1}),jt.addEventListener("touchmove",qm,{passive:!1}),jt.addEventListener("touchend",_c),jt.addEventListener("touchcancel",_c),["mousedown","touchstart","wheel"].forEach(e=>{jt.addEventListener(e,xc,{passive:!0,capture:!0})}),window.addEventListener("keydown",e=>{let t=e.key.toLowerCase();["w","a","s","d"].includes(t)&&(R.keys[t]=!0,e.preventDefault(),R.isIdle&&xc())}),window.addEventListener("keyup",e=>{let t=e.key.toLowerCase();t in R.keys&&(R.keys[t]=!1)});let i=document.getElementById("instructions-toggle");i&&(["mousedown","mouseup","click","touchstart","touchend","touchmove","wheel"].forEach(e=>i.addEventListener(e,t=>t.stopPropagation())),i.addEventListener("click",()=>{document.getElementById("assembly-component").classList.toggle("instructions-off")}))}var Zm=new Mi,wc=new L,Jm=new zt,$m=1.2;function Ac(){function i(){requestAnimationFrame(i);let e=Zm.getDelta();R.elapsed+=e;let t=R.elapsed;if(R.isIdle){R.idleTime+=e;let a=55,l=38,c=4,h=R.idleTime%a,d;if(h<25){let g=h/25,_=g*g*(3-2*g);d=l+(c-l)*_}else if(h<30)d=c;else{let g=(h-30)/25,_=g*g*(3-2*g);d=c+(l-c)*_}let f=.04+(1-d/l)*.1;R.idleAngle+=e*f;let m=Math.sin(R.idleTime*.07)*6;wc.set(Math.cos(R.idleAngle)*d,m,Math.sin(R.idleAngle)*d),R.panTargetX=0,R.panTargetY=0,R.panTargetZ=0,R.panOffsetX=0,R.panOffsetY=0,R.panOffsetZ=0}else R.isDragging||(R.panTargetX+=R.panVelX,R.panTargetY+=R.panVelY,R.panTargetZ+=R.panVelZ,R.panVelX*=.93,R.panVelY*=.93,R.panVelZ*=.93);let n=R.isIdle?.04:.12;if(R.panOffsetX+=(R.panTargetX-R.panOffsetX)*n,R.panOffsetY+=(R.panTargetY-R.panOffsetY)*n,R.panOffsetZ+=(R.panTargetZ-R.panOffsetZ)*n,un.position.x=R.panOffsetX,un.position.y=R.panOffsetY,un.position.z=R.panOffsetZ+Math.sin(t*.15)*3,un.rotation.y=0,un.rotation.x=0,R.isIdle)it.position.lerp(wc,.02),it.lookAt(0,0,0),R.zoom=it.position.length(),R.zoomTarget=R.zoom;else if(R.wakeTransitionTime<1){R.wakeTransitionTime=Math.min(1,R.wakeTransitionTime+e/$m);let a=R.wakeTransitionTime*R.wakeTransitionTime*(3-2*R.wakeTransitionTime);it.quaternion.copy(R.wakeStartQuat).slerp(Jm,a),R.zoom+=(R.zoomTarget-R.zoom)*.05,it.position.copy(R.wakeStartPos).lerp(new L(0,0,R.zoom),a)}else{R.keys.a&&(R.cameraYawVel-=.003),R.keys.d&&(R.cameraYawVel+=.003),R.keys.w&&(R.cameraPitchVel+=.003),R.keys.s&&(R.cameraPitchVel-=.003),R.cameraYawVel=Math.max(-.06,Math.min(.06,R.cameraYawVel)),R.cameraPitchVel=Math.max(-.06,Math.min(.06,R.cameraPitchVel)),R.cameraYaw+=R.cameraYawVel,R.cameraPitch+=R.cameraPitchVel,R.cameraYawVel*=.86,R.cameraPitchVel*=.86;let h=Math.PI*.44;R.cameraPitch=Math.max(-h,Math.min(h,R.cameraPitch)),R.zoom+=(R.zoomTarget-R.zoom)*.05;let d=R.zoom,f=Math.cos(R.cameraPitch);it.position.set(d*f*Math.sin(R.cameraYaw),d*Math.sin(R.cameraPitch),d*f*Math.cos(R.cameraYaw)),it.lookAt(0,0,0)}if(lr.rotation.y+=e*.02,lr.rotation.x+=e*.01,R.selectedCube){let a=1.15+Math.sin(t*4)*.05;R.selectedCube.scale.set(a,a,a),R.selectedEdges.scale.set(a,a,a)}let s=Math.round(-R.panOffsetX),r=Math.round(-R.panOffsetY),o=Math.round(R.zoom);document.getElementById("coord-x").textContent=(s>=0?"+":"")+String(s).padStart(3,"0"),document.getElementById("coord-y").textContent=(r>=0?"+":"")+String(r).padStart(3,"0"),document.getElementById("coord-z").textContent=(o>=0?"+":"")+String(o).padStart(3,"0"),Ti.render()}i()}Tc();Ac();})();
